 ...
 * @param <K> model event
 */
public abstract class SongListPanel<T, K extends IEvent<T>> extends JPanel implements IObserver<T, K> {
	private static final long serialVersionUID = -669290185768399715L;
	
	protected JScrollPane songsScroller;
	protected JList<Object> songs;
	protected AbstractSongContainer<T, K> model;
	
	public SongListPanel(AbstractSongContainer<T, K> model) {
		this.model = model;
